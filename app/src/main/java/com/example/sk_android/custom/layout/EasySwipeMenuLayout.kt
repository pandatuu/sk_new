...
class EasySwipeMenuLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ViewGroup(context, attrs, defStyleAttr) {
    ...
    internal var result: State? = null
        ...
        try {
            ...
            for (i in 0 until indexCount) {
                ...
                if (attr == R.styleable.EasySwipeMenuLayout_leftMenuView) {
                    ...
                    isCanLeftSwipe = typedArray.getBoolean(R.styleable.EasySwipeMenuLayout_canLeftSwipe, true)
                } else if (attr == R.styleable.EasySwipeMenuLayout_canRightSwipe) {
                    isCanRightSwipe = typedArray.getBoolean(R.styleable.EasySwipeMenuLayout_canRightSwipe, true)
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        if (mContentView != null) {
            mContentViewLp = mContentView!!.layoutParams as ViewGroup.MarginLayoutParams
        ...
        if (mLeftView != null) {
            val leftViewLp = mLeftView!!.layoutParams as ViewGroup.MarginLayoutParams
        ...
        if (mRightView != null) {
            val rightViewLp = mRightView!!.layoutParams as ViewGroup.MarginLayoutParams
    ...
    private fun handlerSwipeMenu(result: State?) {
        if (result === State.LEFTOPEN) {
            ...
            viewCache = this
            mScroller!!.startScroll(scrollX, 0, mRightView!!.right - mContentView!!.right - mContentViewLp!!.rightMargin - scrollX, 0)
            stateCache = result
        } else {
