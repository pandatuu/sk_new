...
class FlActionBarFragment:Fragment() {
    ...
    companion object {
        fun newInstance(): FlActionBarFragment {
            return FlActionBarFragment()
        }
    }
            ...
            verticalLayout {
                ...
                relativeLayout(){
                    ...
                    textView {
                        ...
                        width = matchParent
                        height = wrapContent
                        height =dip(65-getStatusBarHeight(this@FlActionBarFragment.context!!))
                        alignParentBottom()
                    }
                }.lparams(){
                    width = matchParent
