...
//
                    val intent = Intent(this@MainActivity, RecruitInfoShowActivity::class.java)
    ...
    private fun getPosition(id: String) {
        val requestUserInfo = RetrofitUtils(this, "https://organization-position.sk.cgland.top/")
        ...
        requestUserInfo.create(OnlineResumeApi::class.java)
            ...
            .subscribe({
                ...
                println("-----正在查找数据")
                //根据获得的公司ID查询公司
                var retrofitUils = RetrofitUtils(this, "https://org.sk.cgland.top/")
                ...
                //根据职位ID查询是否被收藏
                retrofitUils = RetrofitUtils(this, "https://job.sk.cgland.top/")
                ...
                //查询用户信息
                retrofitUils = RetrofitUtils(this@MainActivity, "https://user.sk.cgland.top/")
                ...
                //查询职位地址
                retrofitUils = RetrofitUtils(this@MainActivity, "https://basic-info.sk.cgland.top/")
                retrofitUils.create(CompanyInfoApi::class.java)
    ...
    private fun getModel(model: JsonObject) {
        ...
        getMinAndMax()
        val intent = Intent(this@MainActivity, JobInfoDetailActivity::class.java)
