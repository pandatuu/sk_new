...
class FaActionBarFragment:Fragment() {
    ...
    companion object {
        fun newInstance(): FaActionBarFragment {
            return FaActionBarFragment()
        }
    }
            ...
            verticalLayout {
                ...
                relativeLayout(){
                    ...
                    textView {
                        ...
                        width = matchParent
                        height = wrapContent
                        height =dip(65-getStatusBarHeight(this@FaActionBarFragment.context!!))
                        alignParentBottom()
                    }
                }.lparams(){
                    width = matchParent
