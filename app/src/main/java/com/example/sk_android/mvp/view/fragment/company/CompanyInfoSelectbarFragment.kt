...
class CompanyInfoSelectbarFragment : Fragment() {
    ...
    private lateinit var text2Circle: TextView
                        ...
                        setOnClickListener(object :View.OnClickListener{
                            override fun onClick(v: View?) {
                                ...
                                if (selectIndex != 0) {
                                    ...
                                    text2Circle.textColorResource = R.color.gray89
                                    text2Circle.backgroundResource = R.drawable.circle_border_gray89
                        ...
                        setOnClickListener(object :View.OnClickListener{
                            override fun onClick(v: View?) {
                                ...
                                if (selectIndex != 1) {
                                    ...
                                    text2Circle.textColorResource = R.color.themeColor
                                    text2Circle.backgroundResource = R.drawable.circle_border_theme_color
