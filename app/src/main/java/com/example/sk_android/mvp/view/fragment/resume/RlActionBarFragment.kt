...
class RlActionBarFragment:Fragment() {
    ...
    companion object {
        fun newInstance(): RlActionBarFragment {
            return RlActionBarFragment()
        }
    }
            ...
            verticalLayout {
                ...
                relativeLayout(){
                    ...
                    textView {
                        ...
                        width = matchParent
                        height = wrapContent
                        height =dip(65-getStatusBarHeight(this@RlActionBarFragment.context!!))
                        alignParentBottom()
                    }
                }.lparams(){
                    width = matchParent
