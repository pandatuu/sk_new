...
class SpvActionBarFragment:Fragment() {
    ...
    companion object {
        fun newInstance(): SpvActionBarFragment {
            return SpvActionBarFragment()
        }
    }
            ...
            verticalLayout {
                ...
                relativeLayout(){
                    ...
                    textView {
                        ...
                        width = matchParent
                        height = wrapContent
                        height =dip(65-getStatusBarHeight(this@SpvActionBarFragment.context!!))
                        alignParentBottom()
                    }
                }.lparams(){
                    width = matchParent
