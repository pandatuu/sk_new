...
class SpActionBarFragment:Fragment() {
    ...
    companion object {
        fun newInstance(): SpActionBarFragment {
            return SpActionBarFragment()
        }
    }
            ...
            verticalLayout {
                ...
                relativeLayout(){
                    ...
                    textView {
                        ...
                        width = matchParent
                        height = wrapContent
                        height =dip(65-getStatusBarHeight(this@SpActionBarFragment.context!!))
                        alignParentBottom()
                    }
                }.lparams(){
                    width = matchParent
