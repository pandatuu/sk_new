...
public class FloatOnKeyboardLayout extends RelativeLayout {
    ...
    private View mOldAnchor;
    private int mMarginKeyboard = 0;
    private int mAnchorOriginBottom;
    private OnKeyboardAboutPopupListener mAboutListener;
    ...
    public void setAboutPopupListener(OnKeyboardAboutPopupListener listener) {
        mAboutListener = listener;
    }
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (mAboutListener != null) {
                    mAboutListener.onKeyboardAboutPopup();
                }
    ...
    public interface OnKeyboardAboutPopupListener {
        void onKeyboardAboutPopup();
    }
