...
public class EmoticonViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public EmoticonViewHolder(View itemView, boolean isSender) {
        super(itemView);
